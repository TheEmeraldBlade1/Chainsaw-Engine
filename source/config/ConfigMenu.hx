...
class ConfigMenu extends FlxUIStateExt
{
    ...
    var noteColorValue:Int;
    final showMissesTypes:Array<String> = ["off", "on", "combo breaks"];
    final noteColorTypes:Array<String> = ["default", "red", "green", "yellow", "black", "blue", "purple", "brown", "cyan", "magenta", "lime", "orange"];
    var notecolorNumber:Int = 11;
    ...
    function setupOptions(){
        ...
        noteColorValue = Config.noteColor;
        ...
        var noteColorSetting = new ConfigOption("NOTE COLORS", ": " + noteColorTypes[noteColorValue], "TEMP");
        noteColorSetting.optionUpdate = function(){
            if (pressRight){
                FlxG.sound.play(Paths.sound('scrollMenu'));
                noteColorValue += 1;
            }
            ...
            if (noteColorValue > notecolorNumber)
                noteColorValue = 0;
            if (noteColorValue < 0)
                noteColorValue = notecolorNumber;
            
            noteColorSetting.setting = ": " + noteColorTypes[noteColorValue];
            noteColorSetting.description = noteColorSetting.extraData[noteColorValue];
        };
