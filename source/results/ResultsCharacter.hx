        ...
        switch(character){
            default:
                switch(rank){
                    ...
                    case excellent:
                        bf = new AtlasSprite(1329, 429, Paths.getTextureAtlas("menu/results/characters/bf/excellent"));
                        bf.visible = false;
                    ...
                    case great:
                        ...
                        bf = new AtlasSprite(929, 363, Paths.getTextureAtlas("menu/results/characters/bf/great/bf"));
                        bf.visible = false;
