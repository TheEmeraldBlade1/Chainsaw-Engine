...
class PauseSubState extends MusicBeatSubstate
{
	...
	var menuItemsOG:Array<String> = ['Resume', 'Restart Song', 'Change Difficulty', 'Toggle Practice Mode', 'Toggle Botplay', 'Gameplay Changers', 'Options', 'Exit to menu'];
			...
			switch (daSelected)
			{
				...
				case 'Change Difficulty':
					...
					case 'Gameplay Changers':
						close();
						states.PlayState.instance.openChangersMenu();
				...
				case 'Options':
					...
					options.OptionsMainState.onPlayState = true;
				case "Exit to menu":
